...
yargs
    ...
    .command("app", "View and manage your NextPush apps", (yargs) => {
    isValidCommandCategory = true;
    yargs
        ...
        yargs
            ...
            default: null,
            demand: true,
            description: "OS of the app to add. android or ios",
            type: "string",
        });
        addCommonConfiguration(yargs);
    })
    ...
    .command("debug", "View the NextPush debug logs for a running app", (yargs) => {
    isValidCommandCategory = true;
    isValidCommand = true;
    yargs
    ...
    //   addCommonConfiguration(yargs);
    // })
    .command("login", "Authenticate with the NextPush server in order to begin managing your apps", (yargs) => {
    isValidCommandCategory = true;
    isValidCommand = true;
    yargs
        ...
        default: null,
        demand: false,
        description: "Access key to authenticate against the NextPush server with, instead of providing your username and password credentials",
        type: "string",
    })
        .check((argv, aliases) => isValidCommand); // Report unrecognized, non-hyphenated command category.
    addCommonConfiguration(yargs);
    ...
    .command("register", "Register a new NextPush account", (yargs) => {
    isValidCommandCategory = true;
    isValidCommand = true;
    yargs
    ...
    .command("migrate", "Import all your applications, CodePush versions, and metrics from App Center with a single command using your API key", (yargs) => {
    yargs
        ...
        default: null,
        demand: true,
        description: "App Center API key. You can get your App Center API key from [here](https://appcenter.ms/settings/apitokens/create).",
        type: "string",
    });
    addCommonConfiguration(yargs);
})
    ...
    if (!wasHelpShown && argv._ && argv._.length > 0) {
        ...
        switch (arg0) {
                    ...
                    case "add":
                        if (arg2) {
                            ...
                            if (argv["os"]) {
                                ...
                                arg2.toLowerCase().includes("ios") ? cmd.os = "iOS" : cmd.os = "Android";
                            }
                        }
                        break;
                    case "list":
            ...
            case "release-react":
                ...
                releaseReactCommand.appName = argv["app"] || arg1;
            ...
            case "migrate":
                ...
                migrateCommand.apiKey = argv["api-key"];
                break;
        }
        return cmd;
    }
